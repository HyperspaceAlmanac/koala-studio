...
Events.ConnectForPlayer("HandleKFTime", HandleKFTime)
Events.ConnectForPlayer("HandleKFPosition", HandleKFPosition)
Events.ConnectForPlayer("HandleKFTRotation", HandleKFRotation)
Events.ConnectForPlayer("HandleKFOffset", HandleKFOffset)
Events.ConnectForPlayer("HandleKFWeight", HandleKFWeight)
Events.ConnectForPlayer("HandleKFBlendIn", HandleKFBlendIn)
Events.ConnectForPlayer("HandleKFBlendOut", HandleKFBlendOut)
Events.ConnectForPlayer("HandleKFActive", HandleKFActive)
Events.ConnectForPlayer("HandleCreateKF", HandleCreateKF)
Events.ConnectForPlayer("HandleDuplicateKF", HandleDuplicateKF)
Events.ConnectForPlayer("HandleDeleteKF", HandleDeleteKF)
